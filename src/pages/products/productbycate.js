        ...
        return /* html */ `
                  ...
                  <main class="grid grid-cols-12 bg-white mt-5 p-5 rounded-lg">
                    ...
                    <article class="col-span-9 ">
                      <div class="">
                        <h1 class="uppercase pb-3 font-bold">${data.title}</h1>
                      </div>
                      <hr>
                      <div class="flex py-3">
                        ...
                        <div class="">
                          <div class="py-5 grid gap-3 " style="grid-template-columns: 1fr 1fr 1fr 1fr;">
                              ...
                              <div class="product-item mb-4">
                                ...
                                <div class="pl-2">
                                <span class="font-bold text-[#f53d2d]">${new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(product.price)}</span>
                                <span class="line-through text-sm pl-1">${new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(product.price)}</span>
                                </div>
                              </div>
                              `).join("")}
