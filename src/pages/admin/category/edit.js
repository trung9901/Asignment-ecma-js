                        ...
                        <form action="" id="form-add-category">
                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <input type="text" name="" id="name-category" value="${data.title}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full p-1 border border-gray-300 rounded-md" required>
                                </div>
                                ...
                                <label class="block font-medium text-gray-700"> Ảnh sản phẩm </label>
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                        <div class="flex justify-between ">
                                            <div><input type="file" name="" id="img-category" class=""></div>
