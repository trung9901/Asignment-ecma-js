                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <a href="/#/admin/category/${category.id}/edit" class="text-white hover:bg-black  border-0 rounded bg-green-600 py-2 px-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                        
                                        <button data-id=${category.id} class="btn btn-remove text-white hover:bg-black border-0 rounded bg-red-600 py-2 px-3"><i class="fa-solid fa-trash-can"></i></button>
        ...
        buttons.forEach(button => {
            ...
            button.addEventListener('click', () => {
                ...
                try {
                    if (confirm) {
                        remove(id).then(() => {
                            reRender(AdminCategoryPage, "#app");
